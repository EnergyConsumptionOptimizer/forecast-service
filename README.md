...
![Version](https://img.shields.io/github/v/release/EnergyConsumptionOptimizer/forecast-service)

The Forecast Service is responsible for generating energy consumption predictions using ML algorithms based on historical data.

## Technologies Used
[![Ktor](https://img.shields.io/badge/Ktor-087CFA?style=for-the-badge&logo=ktor&logoColor=white)](https://ktor.io/)
[![Smile](https://img.shields.io/badge/Smile_ML-7F52FF?style=for-the-badge&logo=kotlin&logoColor=white)](https://haifengl.github.io/)
### Database

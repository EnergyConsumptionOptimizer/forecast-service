package io.energyconsumptionoptimizer.forecastservice.domain.port

import io.energyconsumptionoptimizer.forecastservice.domain.value.ForecastedDataPoint

/**
 * Strategy contract for forecast algorithms used by the service.
 *
...
interface ForecastAlgorithm {
    ...
    /**
     * Validate inputs commonly required by forecast algorithms.

 ...
 * forecast logic to a [forecastAlgorithm], aggregates predicted values per
 ...
 * @param forecastAlgorithm Algorithm used to produce time-series forecasts.
...
class ComputeForecastUseCase(
     ...
     * 3. Delegates prediction to [forecastAlgorithm].
    ...
    suspend fun compute(utilityType: UtilityType): ForecastedConsumption {
        ...
        val dataPoints = forecastAlgorithm.forecast(historicalData, forecastHorizon)
